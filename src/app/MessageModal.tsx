  ...
  return (
    <>
      <div className='overflow-x-hidden overflow-y-auto fixed top-0 left-0 right-0 inset-0 z-50 justify-center items-center'>
        <div className='relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-900 dark:border-gray-800'>
            ...
            {tone === 'fail' && (
              <>
                <div className='mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100'>
                  <Icon icon='ph:x-circle' className='h-6 w-6 text-red-600' />
                </div>
                <div className='mt-2 px-7 py-3'>
                  <h3 className='text-lg leading-6 font-medium text-gray-900'>
                    Error!
            ...
            {tone === 'neutral' && (
              <>
                <div className='mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-gray-100'>
                  <Icon icon='ph:question' className='h-6 w-6' />
                </div>
                <div className='mt-2 px-7 py-3'>
                  <h3 className='text-lg leading-6 font-medium text-gray-900'>
                    Save Changes
